...
if (isset($_GET['delete'])) {
  ...
  $sql = "DELETE FROM schemelist WHERE schemeid=$id";
...
// If result is not empty, display data in an HTML table
if (mysqli_num_rows($result) > 0) {
  echo "<table class='table table-hover'>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>" . " " . "</td>";
        echo "<td>" . $row["schemeid"] . "</td>";
        echo "<td>" . $row["name"] . "</td>";
        echo "<td><a href='?delete=" . $row["schemeid"] . "'><img src='assets/img/delete.png' alt='Delete' width='15' height='18'></a></td>";
        echo "<td><a href='modify.php?id=" . $row["schemeid"] . "'><img src='assets/img/edit.png' alt='edit' width='15' height='18'></a></td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
