...
$sql = "UPDATE `applied` SET `statu` = '3' WHERE email = '$email' AND schemeid = '$schemeid'";
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="d-flex justify-content-between align-items-center" style="padding-top: 25px;padding-left: 80px;padding-right: 80px;">
        <h2>Revert application</h2>
        <ol>
          <li><a href="admin_index.php">Schemes</a></li>
          <li>Revert Application</li>
        </ol>
      </div>
    ...
    <div class="form-group">
      <form action = "revertmsg.php"  method="post">
        <label for="text">Write your Query</label>
        <textarea class="form-control" id="msg" name = "msg" rows="7"></textarea>
        <?php
          echo "<input type = 'hidden' value = '".$phone."' name='jinal'>";
          echo "<input type='submit' name='schemebtn' value='Send Message' class='btn btn-primary'>";
        ?>
      </form>
