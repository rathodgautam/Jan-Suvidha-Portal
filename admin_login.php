<!-- INSERT INTO `admins` (`id`, `name`, `email`, `pwd`, `dept`) VALUES (NULL, 'Ridham Patel', 'ridhampatel2002@gmail.com', '1234', 'MYSY'); -->
<?php 
require 'dbconn.php';
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM admins WHERE email = '$email' AND pwd = '$pwd' AND dept ='$schemeid'";
  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="admin_login.php" method="POST" id ="ridham1">

          <!-- Select scheme -->
          <div class="form-outline mb-4">
           
           
            <select name="scheme" id="scheme" class="form-control form-control-lg" placeholder="Select Scheme">
              <option value="1">Meal Bill Assistance</option> 
              <option value="2">Nirdhar Vrudh Sahay</option>
              <option value="3">Abroad Study Loan</option>
              <option value="4">Coaching Assistance</option>
              <option value="5">MYSY</option>
              <option value="6">DG</option>
              <option value="7">MKSY</option>
            </select>
            <label class="form-label" for="emaitl">Scheme</label>
          </div>
          <!-- Email input -->
          <div class="form-outline mb-4">
